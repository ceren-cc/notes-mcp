...
import os
'''
    FastMCP: Allows you to quickly create a server using the MCP (Model Context Protocol).
    os: A standard Python module used for file and directory operations 
        (e.g., creating paths, checking for files, etc.).
'''
...
@mcp.tool()
def add_note(message: str) -> str:  # We will receive a string message and return a string.
    '''
...
def read_notes() -> str:
    ...
    with open(NOTES_FILE, "r") as f:
        content = f.read().strip()    # strip() -> removes newline characters and trailing white spaces
